...
public class SampleLoginWithAmazonActivity extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        try {
            ...
            Log.e(TAG, "Unable to Use Amazon Authorization Manager. APIKey is incorrect or does not exist" +
                    ".", e);
        }
     ...
     * Starts getToken workflow if the authorization was successful, or displays a toast if the user
    ...
    private class AuthListener implements AuthorizationListener {
        ...
        public void onSuccess(Bundle response) {
            runOnUiThread(new Runnable() {
                @Override
                public void run() {
                    // At this point we know the authorization completed, so remove the ability to return
                    // to the app to sign-in again
            ...
            if (profileBundle == null) {
                runOnUiThread(new Runnable() {
                    ...
                    public void run() {
                        ...
                        Toast errorToast = Toast.makeText(getApplicationContext(), errorMessage, Toast
                                .LENGTH_LONG);
                ...
                Log.i("Bob",response.getString(AuthzConstants.BUNDLE_KEY.TOKEN.val));
